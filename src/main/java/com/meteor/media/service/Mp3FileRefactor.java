...
import com.meteor.media.model.MediaFileInfoModel.MediaType;
...
public class Mp3FileRefactor implements ImediaFileRefactor {
	public MediaFileInfoModel getMediaFileInfo(String filePath)
			throws IOException, SAXException, UnsupportedTagException, InvalidDataException, NotSupportedException {
...
//		mp3file.save(filePath+".mp3");
		...
		MediaFileInfoModel mediaFIleInfoModel = new MediaFileInfoModel(MediaType.MP3, filePath);
		mediaFIleInfoModel.setAlbum(id3v2Tag.getAlbum());
		mediaFIleInfoModel.setArtist(id3v2Tag.getArtist());
